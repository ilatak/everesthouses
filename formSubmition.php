﻿<?php 
	...
	$mail_to = 'info@gmail.com'; // Who is the E-Mail going to?
	$mail_from = 'info@gmail.com'; // Where does the E-Mail appear to be from?
	
	// OPTIONAL SETTING
	$redirect_url = 'http://everesthouses.ca/thankyou.html'; 
	...
	$message_body = "Form Submission from EverestHouses.ca \n\n";
